...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>收件箱界面 - Bootstrap管理系统</title>
								...
								<div class="hide message-content" id="id-message-content">
									<div class="message-header clearfix">
										<div class="pull-left">
											...
											&nbsp;
											<img class="middle" alt="John's Avatar" src="koala/avatars/avatar.png" width="32" />
											&nbsp;
									...
									<div class="message-attachment clearfix">
										...
										<div class="attachment-images pull-right">
											...
											<div>
												<img width="36" alt="image 4" src="koala/images/gallery/thumb-4.jpg" />
												<img width="36" alt="image 3" src="koala/images/gallery/thumb-3.jpg" />
												<img width="36" alt="image 2" src="koala/images/gallery/thumb-2.jpg" />
												<img width="36" alt="image 1" src="koala/images/gallery/thumb-1.jpg" />
											</div>
										</div>
									</div>
								</div><!-- /.message-content -->
