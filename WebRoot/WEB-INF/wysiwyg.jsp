...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Bootstrap 编辑器 - Bootstrap管理系统</title>
...
- list item 3</textarea>
								...
								<script type="text/javascript">
									var $path_koala = "koala";//this will be used in loading jQuery UI if needed!
								</script>
...
<![endif]-->
		...
		<script src="koala/js/markdown/markdown.min.js"></script>
		<script src="koala/js/markdown/bootstrap-markdown.min.js"></script>
	...
	if ( typeof jQuery.ui !== 'undefined' && /applewebkit/.test(navigator.userAgent.toLowerCase()) ) {
		...
		if (typeof jQuery.ui !== 'undefined') enableImageResize();
			...
			$.getScript($path_koala+"/js/jquery-ui-1.10.3.custom.min.js", function(data, textStatus, jqxhr) {
				if('ontouchend' in document) {//also load touch-punch for touch devices
					$.getScript($path_koala+"/js/jquery.ui.touch-punch.min.js", function(data, textStatus, jqxhr) {
						enableImageResize();
					});
